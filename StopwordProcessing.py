...
input_folder = 'Lifestyle'  # Relative path from the current working directory
output_folder = 'ProcessedLifestyle'  # Relative path from the current working directory
