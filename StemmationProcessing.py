...
input_folder = 'ProcessedDisease'  # Relative path from the current working directory
output_folder = 'StemmationProcessedDisease'  # Relative path from the current working directory
